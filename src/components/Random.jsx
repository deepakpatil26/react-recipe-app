...
const Random = () => {
  ...
  const getRandomRecipes = async () => {
    try {
      const cacheKey = 'random_recipes';
      const cacheExpiry = 'random_recipes_expiry';
      ...
      console.error("Random recipes fetch error:", error);
  ...
  if (error) {
    return (
      <div className="my-16 text-center">
        <h3 className="text-xl font-bold mb-4 text-red-500">Error Loading Random Picks</h3>
  ...
  if (!random.length) {
    return (
      <div className="my-16 text-center">
        <h3 className="text-xl font-bold mb-4">No Random Picks Available</h3>
  ...
  return (
    ...
    >
      <h3 className="text-2xl font-bold mb-8">Random Picks</h3>
      <Splide
        options={{
          perPage: 4,
          arrows: true,
